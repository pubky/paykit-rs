...
>
> Domain rule: the terms below win over older README/code wording when creating new names. Legacy names remain documented so existing code can be read and migrated deliberately.
