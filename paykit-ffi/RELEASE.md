...
This bumps the version consistently in `paykit-ffi/Cargo.toml`, `paykit-lib/Cargo.toml`, `Package.swift`, and `gradle.properties`, then builds both platforms and updates the `Package.swift` checksum.
