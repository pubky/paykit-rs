...
const FIXTURE_UNKNOWN_KIND_JSON: &str = r#"{"version":1,"kind":"paykit.allowance","body":{}}"#;
...
fn envelope_fixture_state() -> StorageState {
    ...
    state.private_stream_items = vec![
        paykit_sdk::storage::PrivateStreamItemRecord {
            stream_item_id: 0,
            counterparty: counterparty.clone(),
            counterparty_receiver_path: receiver_path.clone(),
            receive_batch_id: 0,
        ...
        // An already-normalized item for a well-formed future kind, exactly as
        // the current classifier persists it. Freezing it here pins the
        // postcard discriminant of `PrivateStreamParseStatus::UnknownKind` in
        // real persisted bytes: an intermediate reader that does not know the
        // kind must decode this item with its status intact.
        paykit_sdk::storage::PrivateStreamItemRecord {
            stream_item_id: 1,
            counterparty,
            counterparty_receiver_path: receiver_path,
            receive_batch_id: 0,
            raw_json: FIXTURE_UNKNOWN_KIND_JSON.into(),
            parsed_version: Some(1),
            parsed_kind: Some("paykit.allowance".into()),
            known_paykit_kind: None,
...
const STATE_ENVELOPE_V1_HEX: &str = "";
const BACKUP_ENVELOPE_V1_HEX: &str = "";
...
async fn test_generation_1_state_normalizes_then_reencodes_as_generation_2() {
    ...
    // The unknown-kind item is already in normalized form, so normalization
    // must carry it through with no logical change.
    let unknown = &envelope.state.private_stream_items[1];
    assert_eq!(unknown.raw_json, FIXTURE_UNKNOWN_KIND_JSON);
    assert_eq!(unknown.parse_status, PrivateStreamParseStatus::UnknownKind);
    assert_eq!(unknown.parse_error, None);
}
...
async fn test_ffi_storage_claim_leaves_parked_unknown_head_unchanged() {
    ...
    // Completes the intermediate-reader case: the gen-2 blob carries an
    // unknown-kind stream item alongside the parked queue head, and both must
    // survive the claim path byte-for-byte.
    let unknown_stream_item = paykit_sdk::storage::PrivateStreamItemRecord {
        stream_item_id: 0,
        counterparty: counterparty.clone(),
        counterparty_receiver_path: receiver_path.clone(),
        receive_batch_id: 0,
    ...
    let state = StorageState {
        ...
        private_stream_items: vec![unknown_stream_item.clone()],
        next_receive_batch_id: 1,
    ...
    assert_eq!(decoded.private_stream_items, vec![unknown_stream_item]);
}
