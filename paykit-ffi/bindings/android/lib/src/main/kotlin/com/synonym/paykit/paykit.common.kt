...
public interface PaykitSdkInterface {
     ...
     */
    @Throws(PaykitException::class, kotlin.coroutines.cancellation.CancellationException::class)
    public suspend fun `claimPaymentRequestForExecution`(`counterparty`: kotlin.String, `paymentRequestId`: kotlin.String): PaymentRequestRecord
     ...
     */
    @Throws(PaykitException::class, kotlin.coroutines.cancellation.CancellationException::class)
    public suspend fun `deletePaykitProfile`(`expectedRevision`: kotlin.String)
     ...
     */
    @Throws(PaykitException::class, kotlin.coroutines.cancellation.CancellationException::class)
    public suspend fun `publishPaykitProfile`(`profile`: PaykitProfile, `expectedRevision`: kotlin.String?): PaykitProfileRecord
     ...
     */
    @Throws(PaykitException::class, kotlin.coroutines.cancellation.CancellationException::class)
    public suspend fun `releasePaymentRequestExecutionClaim`(`counterparty`: kotlin.String, `paymentRequestId`: kotlin.String): PaymentRequestRecord
...
public data class PaymentRequestRecord (
     ...
     */
    val `executionClaimAppId`: kotlin.String?,
    /**
