...
internal object IntegrityCheckingUniffiLib : Library {
    ...
    private fun uniffiCheckApiChecksums() {
        ...
        if (uniffi_paykit_checksum_method_ffipaykitsdk_publish_paykit_app() != 44538.toShort()) {
            throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
        }
        ...
        if (uniffi_paykit_checksum_method_ffipaykitsdk_remove_paykit_app() != 58821.toShort()) {
            throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
        }
        ...
        if (uniffi_paykit_checksum_method_ffipaykitsdk_set_default_paykit_app() != 11225.toShort()) {
            throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
        }
        if (uniffi_paykit_checksum_method_ffipaykitsdk_set_default_paykit_app_for_endpoint() != 15069.toShort()) {
            throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
        }
