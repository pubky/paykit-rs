...
Neither state can be reopened by a later Acceptance. The first crossing Acceptance may
be recorded on a cancelled request only as described above; another Acceptance
is invalid. A crossing
